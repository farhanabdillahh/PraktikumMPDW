---
title: "Tugas Mandiri Pengantar Model Linear 2"
...
model_names <- c("model1.ma2", "model2.ma2", "model3.ma2", "model4.ma2", "model5.ma2")
...
### Overfitting
```{r}
model4a.da=Arima(train.diff, order=c(1,1,2),method="ML")
summary(model4a.da) #AIC=4749.85 
lmtest::coeftest(model4a.da) #ma1 signifikan

model4b.da=Arima(train.diff, order=c(0,1,3),method="ML")
summary(model4b.da) #AIC=4749.3
lmtest::coeftest(model4b.da) #ma1 ma2 signifikan
```
Model ARIMA(2,1,0) sebelumnya memiliki AIC 4748.295 (lebih kecil). Oleh karena itu, model terbaiknya setelah overfitting adalah ARIMA(2,1,0).
