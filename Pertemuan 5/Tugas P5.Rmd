---
title: "Pemeriksaan Stasioneritas Data"
output:
...
Gambar di atas menunjukkan nilai *rounded value* ($\lambda$) optimum sebesar **1,01** dan pada selang kepercayaan 95% nilai memiliki batas bawah **0,00** dan batas atas **2,63**. Selang tersebut memuat nilai satu sehingga dapat dikatakan bahwa data  stasioner dalam ragam.
